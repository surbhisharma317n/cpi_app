...
useEffect(() => {
 ...
 <style>{`
        /* Move stripes left → right and restart */
          ...
          {isValidationComplete && !isValidating &&  (
            <div className="flex flex-col items-center justify-center py-10 space-y-4">
              <p className="text-green-500 text-sm"> 
                Validation and uploading data are completed successfully.
                </p>
              <span className="text-gray-500 text-sm">Now You can Proceed to Compile.</span>
              {/* <ProgressBar3Stage stage={STAGES.VALIDATING} /> */}
                </div>
                )}
          {isCompiling ? (
            <div className="flex flex-col items-center justify-center py-10 space-y-4">
  ...
  <div
    className="h-full bg-green-500 transition-all duration-200 bg-stripe"
...
`}</style>
          ...
          {isCompilationComplete && !isCompiling &&  (
            <div className="flex flex-col items-center justify-center py-10 space-y-4">
              <p className="text-green-500 text-sm">
                Compilation is completed successfully.
                </p>
              <span className="text-gray-500 text-sm">You can close this dialog.</span>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                isValidationComplete === false || isCompiling 
              }
              className="bg-blue-900 hover:bg-blue-800 text-white"
            >
