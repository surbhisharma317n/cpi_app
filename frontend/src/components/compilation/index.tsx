...
import ComprehensiveTabs from "./ComprehensiveTabs";

export default function CompilationProgram() {
  const [activeProgram] = useState("rural_price_index");
  const [activeComprehensiveTab, setActiveComprehensiveTab] = useState(
      ...
      <div className="bg-white rounded-lg shadow-lg">
        ...
        <div className="flex flex-col">
          ...
          /> */}
            ...
            <div className="mt-1">
              {activeProgram === "comprehensive_indices" && (
                <ComprehensiveTabs
                  activeTab={activeComprehensiveTab}
                  setActiveTab={setActiveComprehensiveTab}
                />
              )}
