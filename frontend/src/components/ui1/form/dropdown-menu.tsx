...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[12rem] overflow-hidden rounded-lg border border-gray-200 bg-white p-1 text-gray-950 shadow-lg shadow-black/5",
...
>(({ className, inset, destructive, disabled, active, icon, shortcut, children, ...props }, ref) => (
