...
(async () => {
  ...
  console.log('Screenshot saved to C:\Users\SURBHI\AppData\Local\Temp\claude\c--Users-SURBHI-Desktop-Project-my-project-cpi_app\cf075fb1-256c-4046-b8a1-9ba3d8dd0ccf\scratchpad\login-page.png');
  await browser.close();
})();
