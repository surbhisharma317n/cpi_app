...
from api.authentication.login import login_api_simple as login_api, get_captcha_api
...
from api.upload_input_data.all_price_data import  validate_price_data
from api.compiltaion_scripts.all_price_data import   compilation_index
...
from api.authentication.token_refresh import custom_refresh_token
from api.filter_yr_mnth.compilation_filter import get_compilation_filters
from api.filter_yr_mnth.filter_view_yr_mnth import get_filters
...
urlpatterns = [
    ...
    path('token/refresh/', custom_refresh_token, name='token_refresh'),
    ...
    # path('db-upload-progress/<str:session_id>/', get_db_upload_progress, name='db-upload-progress'),
     ...
     # upload input api
    #  upload-zip-validate/
    # path('upload/sessions/', crea, name='upload-session'),
    # path('upload-zip-validate/', upload_zip_validate, name='upload-zip-validate'),
    ...
    # path("compilation-index/", compilation_index, name="compilation-index")
     ...
     #filter_year _ month api
    path('filter/', get_filters, name='filter_month_year'),
    path('compilation_filter/', get_compilation_filters, name='get_compilation_filters'),
